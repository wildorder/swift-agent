...
<!-- Last updated: 2026-07-20 after programs: product-x, management-api, core-runtime-completion, persist-observe, realtime-cloud-delivery, sdk-dev-ux -->
...
API-key auth, Cognito JWT auth. Session creation returns the canonical
